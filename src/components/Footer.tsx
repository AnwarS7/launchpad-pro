      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="border-t border-charcoal/5 pt-8">
          <div className="flex justify-center gap-6 mb-6">
            <a
              href="https://www.instagram.com/modern_silk_arts_?igsh=MWFudTF0ZGc1bWpzMQ=="
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.facebook.com/share/1CqedS3bLz/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-charcoal/70 hover:text-gold transition-colors"
              aria-label="Facebook"
          ...
          <p className="text-label text-charcoal/50 text-center">
